...
export default function Footer() {
  ...
  return <footer className="mt-20 border-t">
    <div className="container-x grid gap-10 py-14 md:grid-cols-3">
      <div><div className="text-2xl font-extrabold">VELORA.</div><p className="mt-3 max-w-sm text-sm text-slate-500">Thoughtful products, premium design and a shopping experience built for modern India.</p></div>
    ...
    <div className="border-t py-5 text-center text-xs text-slate-500">© 2026 Velora. All rights reserved.</div>
  </footer>;
}
